...
class Menu():
    ...
    def show_menu(self):
        ...
        if self.check_game_save() and not self.game.start:
            ...
            resume_button = Button(self.menu_frame, text="Resume", command=self.resume_game, font=("Menlo", 16))
        ...
        high_score_button = Button(self.menu_frame, text="Leaderboard", command=self.show_high_score, font=("Menlo", 16))
    ...
    def show_settings(self):
        ...
        self.up_val = Label(self.settings_frame, text=self.pacman.key_up, font=("Menlo", 13), anchor="w")
        ...
        self.left_val = Label(self.settings_frame, text=self.pacman.key_left, font=("Menlo", 13), anchor="w")
        ...
        self.down_val = Label(self.settings_frame, text=self.pacman.key_down, font=("Menlo", 13), anchor="w")
        ...
        self.right_val = Label(self.settings_frame, text=self.pacman.key_right, font=("Menlo", 13), anchor="w")
        ...
        pause_label = Label(self.settings_frame, text="Pause Game: ", font=("Menlo", 13), anchor="w")
        pause_label.place(x=40, y=205, height=20, width=105)
        self.pause_val = Label(self.settings_frame, text=self.pacman.key_pause, font=("Menlo", 13), anchor="w")
